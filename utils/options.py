...
def get_args():
    ...
    ######################## dataset ########################
    parser.add_argument("--dataset_name", default="RSTPReid", help="[CUHK-PEDES, ICFG-PEDES, F30K, RSTPReid]")
    parser.add_argument("--sampler", default="random", help="choose sampler from type idtentity and random")
    parser.add_argument("--num_instance", type=int, default=4)
    parser.add_argument("--root_dir", type=str, default="/data/wenjunying/UNIReID/UNIReID-main/data/")
